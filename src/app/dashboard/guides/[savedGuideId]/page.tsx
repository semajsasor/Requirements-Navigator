    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start">
        <article className="min-w-0">
          ...
          <h1 className="mt-4 text-3xl font-semibold leading-tight tracking-normal break-words sm:text-4xl lg:text-5xl">
            {guide.title}
          </h1>
        ...
        <aside className="grid gap-4 lg:sticky lg:top-24">
          <Card className="bg-white">
            ...
            <CardContent className="grid gap-4">
              ...
              <ProcessActions
                checklistText={buildProcessChecklistText(guide)}
                downloadFilename={`${guide.slug}-saved-guide-summary.txt`}
              />
          ...
          <SavedGuideNotes
            savedGuideId={savedGuide.id}
            notes={savedGuide.notes}
            reminders={savedGuide.reminders}
          />
