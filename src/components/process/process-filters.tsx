...
export function ProcessFilters({
  ...
  return (
    <Card className="border-primary/10 bg-white/95 shadow-xl shadow-slate-900/5">
      <CardContent className="grid gap-4 p-3 sm:gap-5 sm:p-5">
        <div className="grid gap-3 lg:grid-cols-[1fr_auto] lg:items-center">
          <label className="relative block">
            ...
            <Input
              ...
              className="bg-white pl-9 text-sm shadow-inner shadow-slate-900/5"
            />
          </label>
          <div className="flex min-h-11 items-center gap-2 rounded-md bg-secondary px-3 py-2 text-sm font-medium text-secondary-foreground lg:bg-transparent lg:px-0 lg:py-0 lg:text-muted-foreground">
        ...
        <details className="group md:hidden">
          <summary className="flex min-h-11 cursor-pointer list-none items-center justify-between rounded-md border bg-white px-3 py-2 text-sm font-medium shadow-sm focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring/20">
...
function FilterButton({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        "min-h-10 rounded-md border bg-white px-3 py-1.5 text-sm font-medium text-muted-foreground shadow-sm transition-all duration-200 hover:border-primary/40 hover:text-foreground focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring/20 active:translate-y-px sm:min-h-11 sm:px-3.5 sm:py-2",
